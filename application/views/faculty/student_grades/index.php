        ...
        <div class="container-fluid">
            <div class="row  mb-3">
                ...
                <div class="col-sm-12 pl-1 pt-2">
                    ...
                    <?php } else { ?>
                        <a id="btn_print" href="<?= base_url()?>student-grade/print/<?= $slug_subject;?>/<?= $id;?>" role="button" class="btn btn-info text-uppercase font-weight-bold">
                    ...
                    <tbody>
                        <?php foreach($students as $student) { ?>
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <?php if($student['grade_status'] == 1 && $student['grade_status'] != null) { ?>
                                        <div class="badge badge-success">Passed</div>
                                    <?php } elseif($student['grade_status'] == 0 && $student['grade_status'] != null) { ?>
