        ...
        <div class="container-fluid">
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    value="<?= set_value('total_items');?>"
                />
            </div>
            <div class="d-flex justify-content-between">
                <a href="<?= base_url()?>grade-criteria/<?= $slug_subject;?>/<?= $id;?>" class="btn btn-primary text-uppercase font-weight-bold">
                    Go Back
                </a>
